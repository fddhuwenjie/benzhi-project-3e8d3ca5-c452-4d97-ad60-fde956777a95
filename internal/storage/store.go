...
type Store struct {
	...
	dossierMu sync.RWMutex
	dossiers  map[string]evidence.ClosureDossier
}
...
func New(dir string) (*Store, error) {
	...
	s := &Store{dir: dir, cases: map[string]*domain.ClosureCase{}, events: map[string][]domain.Event{}, idem: map[string]IdempotentResult{}, drafts: map[string]domain.LayerDraft{}, dossiers: map[string]evidence.ClosureDossier{}}
